...
@core.deprecated("Please use mark_to_drop(standard_metadata) instead.")
...
@core.deprecated("Please use verify_checksum/update_checksum instead.")
extern Checksum16 {
    Checksum16();
...
@core.deprecated("Please use 'resubmit_preserving_field_list' instead")
...
@core.deprecated("Please use 'recirculate_preserving_field_list' instead")
...
@core.deprecated("Please use 'clone_preserving_field_list' instead")
...
parser Parser<H, M>(core.packet_in b,
                    out H parsedHdr,
                    inout M meta,
 ...
 */
@deparser
control Deparser<H>(core.packet_out b, in H hdr);
