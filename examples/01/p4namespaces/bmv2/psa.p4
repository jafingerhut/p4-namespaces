...
// used within the definitions of PSA.  We could also potentially use
// `#include <core.p4>` intended for use by P4 developers in their
// programs, which would import all names from the core namespace
// here, if we figure out what to do about `optional` being a core
// annotation name, and also a PSA match kind.
